<div {{$container}}>
<{{$componentElement}} class="{{ $class }}" target="{{ $target }}" js-toggle-trigger="{{$id}}" js-toggle-single="{{$baseClass}}--{{$background}}__toggled" aria-pressed="{{$pressed}}" href="{{ $href }}" {!! $attribute !!}>   
